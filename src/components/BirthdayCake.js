...
const BiarthdayCake = (props) => {
    ...
    const getprice = (size,theme) => {
        ...
        if(theme === "American ButterCream"){
            themePrice = 20000
        }
        else if(theme === "Italian ButterCream"){
            themePrice = 15000
        }
        else if(theme === "German ButterCream"){
            themePrice = 10000
        }

        finalPrice =sizePrice + themePrice;
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            let customPrice = getprice(values.size, values.theme);
    ...
    return (
        <>
            ...
            <Row className="px-3">
                ...
                <Col>
                    {/* <Form.Select
                        ...
                        name="theme"
                        onChange={formik.handleChange}
                        isInvalid={!!formik.errors.theme}
                    >
                        <option readOnly >Pilih Butter Cream</option>
                        <option value="American">American ButterCream</option>
                        <option value="Italian">Italian ButterCream</option>
                        <option value="German">German ButterCream</option>
                    </Form.Select> */}
                    <Form.Group>
                    <Form.Label className="fw-bold">Choose Butter Cream</Form.Label>
                    <Form.Check
                            id="theme"
                            name="theme"
                            type="radio"
                        ...
                        <Form.Check
                            ...
                            // onBlur={formik.handleBlur}
                            onChange={formik.handleChange}
                            label="German ButterCream"
                            value="German ButterCream"     
                            isInvalid={!!formik.errors.theme}
                        />
                    </Form.Group>
                </Col>
            ...
            <Row className="px-3 mt-2">
                ...
                <Col>
                    ...
                    >
                        ...
                        <option value="Keu">Extra Keju</option>
            ...
            <Row className="g-0 m-3">
                <Form.Group>
                    <Form.Label className="fw-bold">Writing Request</Form.Label>
                    <Form.Control
                        id="cakeText"
                        name="cakeText"
                        ...
                        onBlur={formik.handleBlur}
                        onChange={formik.handleChange}
                        value={formik.values.cakeText}
                        isInvalid={!!formik.errors.cakeText}
                    />
                    {formik.touched.cakeText && formik.errors.cakeText ? <Form.Control.Feedback type="invalid">{formik.errors.cakeText}*</Form.Control.Feedback> : null}
                </Form.Group>
            </Row>
            ...
            {<>
                ...
                <Row style={{ backgroundImage: "linear-gradient(to top, #badfe7, #c8e6e3, #daebe3, #eaf0e8, #f6f6f2)" }} className="g-0 py-3 justify-content-center">
                    <Card style={{ backgroundColor: "#FBAB7E", backgroundImage: "linear-gradient( 174.2deg,  rgba(255,244,228,1) 7.1%, rgba(240,246,238,1) 67.4% )" }} className="w-50 p-2">
                        ...
                        <Card.Body>
                            <Card.Title> {formik.values.flavor}</Card.Title>
                            ...
                            <ListGroup variant="flush">
                                ...
                                <ListGroup.Item>Cake Text: {formik.values.cakeText}</ListGroup.Item>
                                <ListGroup.Item>Address: {formik.values.address}</ListGroup.Item>
                                <ListGroup.Item>Delivery Date: {formik.values.date}</ListGroup.Item>
                                <ListGroup.Item>Delivery Hours: {formik.values.time}</ListGroup.Item>
                            </ListGroup>
                        </Card.Body>
                        <h5>Total: {getprice(formik.values.size,formik.values.theme)} </h5>
                    </Card>
                </Row>
            </>
            } 
    ...
    <Row className="g-0 px-2">
      <h6 className="mx-1 w-75">Upload Payment Proof</h6>
                            <Form.Control
                                id="productImage"
                                name="productImage"
                                type="file"
